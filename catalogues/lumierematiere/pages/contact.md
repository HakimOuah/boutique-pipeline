...
Pour un retour, une casse à la réception ou un suivi de colis, indiquez votre numéro de commande et joignez des photos si besoin : le traitement n’en sera que plus rapide. Les règles précises sont dans la [FAQ](/pages/faq), la [politique de livraison](/policies/shipping-policy) et la [politique de retours](/policies/refund-policy).
