...
- **Audit de cohérence 25/08** : `shopify/AUDIT-COHERENCE-2026-08-25.md` — P1 livraison **corrigé** (France only, 0 €). Restent P2 : 13 groupes de titres dupliqués (31 fiches), lien menu `/apps/parcelpanel` à vérifier, blocs démo à faux chiffres désactivés mais présents dans le JSON du hero.
