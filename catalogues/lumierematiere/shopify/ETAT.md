...
- **Copy humanisée 25/08 soir (Opus 5)** : 0 tiret cadratin / demi-cadratin dans le texte client (pages, policies, home, header, footer, 14 collections, 120 fiches). Cadence machine cassée (anaphores « matière / lumière », tricolons, ouvertures identiques). Rapports : `HUMANISATION-PAGES-2026-08-25.md`, `HUMANISATION-THEME-2026-08-25.md`, `HUMANISATION-PDP-2026-08-25.md`. Helio / UNIVERS non écrits. **Reste** : libellés d’options variantes et alt des médias (texte fournisseur brut, hors `push_copy`).
