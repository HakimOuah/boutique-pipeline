...
Pour expliciter la différenciation, écrire une thèse en une phrase :
...
Sans thèse claire, le produit reste insuffisamment étayé pour une recommandation technique favorable.

Les exclusions actuelles sont celles des critères (§3–4), notamment technique-particulier ≠ technique-pro. Les exemples historiques ne créent pas de veto supplémentaire sur une catégorie.
