...
Search privilégie pédagogie, comparaison, objections et preuve. Un produit technique pour un particulier n'est pas un produit professionnel. Examiner densité concurrentielle et espace exécutable : la présence d'un concurrent seul ne prouve pas une impossibilité.

Après pass, sourcer le produit exact et ses variantes, calculer sa contribution et établir l'angle défendable. Shopping éventuel après validation reste une extension ; il ne crée pas une branche « Both » ni un autre seuil initial.
