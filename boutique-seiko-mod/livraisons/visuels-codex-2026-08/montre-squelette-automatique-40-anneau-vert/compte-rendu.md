# Montre squelette automatique 40 — anneau vert

- Livré : 5 visuels de galerie et 1 visuel de variante.
- Sources retenues : `22.jpg` pour la variante exacte vue de face ; `06.jpg` pour le fond transparent commun à la famille.
- Appariement : `Green Chapter Ring A`, sans ambiguïté.
- Vérité visuelle : l'anneau observé est turquoise très clair, et non vert foncé.
- La face `22.jpg`, classée `reserve`, a été utilisée par recomposition complète : poignet, filigrane, film protecteur et marquage coloré ne sont repris dans aucun rendu.
...
- Contrôle zoomé g1 à g4 : anneau turquoise clair, exactement douze plots ronds, mouvement ajouré et trotteuse métallique neutre à détail circulaire cohérents.
...
- Fichiers livrés : JPEG sRGB, 2048 × 2048 px, de 537 à 835 Ko.
...
Bloc commun : fidélité stricte à l'anneau turquoise clair observé, douze plots ronds, produit stérile, aucune inscription ni marque, aucun film ou marquage coloré sur le bracelet, fond `#E7E4DE` vers `#FAFAF7`, 12 h en haut et couronne à droite.
