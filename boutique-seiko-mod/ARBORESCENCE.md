...
## Niveau 1 — La tête de boutique

| Mot-clé | Volume | KD | Usage |
|---|---:|---:|---|
| `montre automatique homme` | **9 900** | 29 | Page d'accueil, chapeau de gamme. KD élevé : c'est un objectif de fond, pas une porte d'entrée. |
| `seiko mod` | 8 100 | 10 | ⚠️ **Marque tierce — interdit en flux Merchant Center.** Utilisable en blog et en contenu éditorial uniquement, jamais dans un titre produit. Grappe ≈ 9 930. |
| `montre personnalisable` | 1 000 | — | Angle « monter sa montre », grappe ≈ 1 640. Piste de contenu. |

L'acquisition réelle ne se joue pas ici mais au niveau des familles, où les KD tombent entre **6 et 16**.
...
## Niveau 2 ter — Collections accessoires (la plus grosse demande de la boutique)
...
## Niveau 3 — Sous-collections de « Cadrans de montre »
...
| Ce qu'on a construit cette semaine | Volume | Ce qui existait déjà | Volume |
|---|---:|---|---:|
| Collection « Cadrans squelette », 10 fiches | **20** | Montres squelette, 2 fiches actives | **5 780** |
...
marques, et un panier trois à sept fois plus faible — **ils ne peuvent pas être la marque**. Mais ils
sont la seule famille à la fois **prête, à intention commerciale et au bon prix** : la porte d'entrée
la moins chère de la boutique est un **remontoir**, pas une montre. Voir §7 du compte rendu du 14/08.

---

## Contraintes de prix (ratio Kraken prix ÷ CPC ≥ 100)

| Collection | CPC | Prix plancher pour tenir le ratio |
|---|---:|---|
| Outils | 0,20 € | **≥ 19,90 €** (12,90 € donne 65, sous le seuil) |
| Verres saphir | 0,30 € | **≥ 29,90 €** (24,90 € donne 83) |
| Boîtiers | 0,64 € | **≥ 64 €** |
| Cadrans | 0,17 € | ≥ 24,90 € ✔, cible atteinte dès 29,90 € |
| Mouvements | 0,21 € | ≥ 29,90 € ✔ |
| Aiguilles | 0,10 € | 19,90 € → ratio 199 ✔ |
| **Remontoirs** | **0,55 $** | **≥ 55 €** — ✅ toute la famille tient, `remontoir-solo` 59,90 € donne 109 (juste) |
| **Boîtes et coffrets** | **0,46 $** | **≥ 46 €** — ⚠️ `coffret-douze-aluminium` démarre à 24,90 € (ratio 54) → passer le premier prix à **49,90 €** |
| **Écrins et rouleaux** | **0,36 $** | **≥ 36 €** — ⚠️ coussins 19,90 € (55) et rouleau bleu marine 29,90 € (83) sous le seuil → plancher **39,90 €** |
| **Bracelets** (cote en mm) | **0,27 $** | **≥ 27 €** — ⚠️ milanais 14,90 € (55), daim 17,90 € (66), gaufré 24,90 € (92) sous le seuil |
| **Bracelets** (tête `bracelet montre`) | **0,41 $** | ⛔ **≥ 41 €** : 6 bracelets sur 10 tombent. **À ne cibler qu'en organique.** |
| **Carte cadeau** | 1,97 $ | ⛔ sans objet — 20 recherches, aucune acquisition payante |

**Lecture d'ensemble des accessoires** : les deux sous-familles qui portent le volume — remontoirs et
...
Amazon étant une porte fermée, pas une porte difficile · l'Analyse par lots SEMrush reste
inaccessible (champ `contenteditable` non pilotable), d'où 26 mots-clés mesurés un par un et non 100
· coûts fournisseur des accessoires non repris, donc les prix planchers ci-dessus sont des
