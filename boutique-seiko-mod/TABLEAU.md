...
**État** : 🟢 **La grille est prête — [`GRILLE-PRIX.md`](GRILLE-PRIX.md), 14/08.** Il ne reste que l'arbitrage. · **Pour** : Hakim
**Ce qui a été fait le 14/08** : les **96 fiches actives** chiffrées une par une — comparable identifié fiche par fiche selon ta règle (*juste en dessous du concurrent qui vend le même produit*), prix cible, écart, **coût rendu, marge en euros, marge en %, coefficient**. Contrôle prix ÷ CPC fait sur les 96. **Aucun prix n'a été écrit sur Shopify, aucun `compareAtPrice` réintroduit.**
...
**Ce qui reste bloqué sur toi** : ① valider ou corriger la grille · ② trancher le sort des **7 Intégrale** · ③ dire si on applique en une passe ou par famille.
