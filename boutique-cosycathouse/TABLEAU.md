...
**État** : FAIT PARTIEL 08/09 · Produit `15881611379071` (handle `insulated-outdoor-cat-house`, ACTIF, publié Boutique en ligne) : L Grey 89 £ `CCH-L-GREY`, M Grey 79 £ `CCH-M-GREY`, description + SEO ; collection `outdoor-cat-shelters`. Variante M supprimée 08/09 (décision Hakim). Images composées livrées par Codex (lots 1b + 2, brief `BRIEF-VISUELS-CODEX-2026-09-08.md`) et branchées : galerie 6 images, collection, bénéfices, hero. **Reste** : mappage DSers (1005010759559289 L grise → `CCH-L-GREY`).

### T-10 — Build thème FullStack (copie `199695565183`) + QA mobile-first
**État** : QA MOBILE + DESKTOP FAITE 08/09 (journal `2026-09-08-qa-mobile.md`) · settings/header/footer, index/product/collection/search/password/page, démo purgée, 0 preuve sociale, logo mot-image en place, langue `en` par défaut sur les domaines, comparatif lisible sur mobile, guide des tailles réel. Images en place (hero desktop/mobile, bénéfices, galerie). **Reste** : publication = Hakim.
