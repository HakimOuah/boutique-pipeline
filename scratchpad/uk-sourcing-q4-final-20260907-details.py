...
IDS = [
    '1005008086495961',  # 39cm wooden chess set
    '1005012070192886',  # 45cm high-end solid wood chess set
    '1005009030731602',  # crystal singing bowls colored set candidate
    '1005009424303397',  # transparent rainbow crystal singing bowl candidate
]
