...
- 1d Persona & psychologie d'achat — **OBLIGATOIRE, livrable dédié** : produire `personas/persona-<produit>-<date>.md`
...
- **Pré-requis bloquant : le persona (`personas/persona-<produit>-<date>.md`, étape 1d) est écrit et
  validé par Hakim. Tout le copy (home, page produit, FAQ, emails) se base explicitement dessus :
  ton, langage client, objections→réponses. Pas de persona validé = pas de rédaction.**
