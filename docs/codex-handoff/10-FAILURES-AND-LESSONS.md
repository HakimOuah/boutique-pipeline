...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-sourcing-accessoires-v3.md §Notes de méthode]** **[NOTION]**
- **Symptôme** : les URL de recherche `/w/wholesale-*.html` servaient un challenge (`fr.aliexpress.com/wp.html`) ; la page chargeait ses images mais n'hydratait jamais son texte. Conclusion v2 (fausse) : « découverte par mot-clé impossible », confirmée « par les trois agents de recherche » (`boutique-seiko-mod/journal/2026-07-25-sourcing-familles-v2.md` l.24, `boutique-seiko-mod/journal/2026-07-25-sourcing-accessoires-v2.md` l.87).
...
- **Résultat** : **zéro CAPTCHA** — recherche globale 12-14 fiches, recherche intra-boutique (`/store/<id>/pages/all-items.html?SearchText=…`) 40 fiches. Aucun CAPTCHA jamais franchi : « le challenge a simplement disparu en changeant de navigateur ». Reconfirmé les 27/07 et 30/07 (`boutique-seiko-mod/journal/2026-07-31-sourcing-chiffres-orientaux.md` : 14 requêtes, 0 CAPTCHA).
...
- **Prévention** : ne jamais résoudre un CAPTCHA ; si un challenge apparaît, changer de navigateur/session avant de conclure à une limite. `boutique-seiko-mod/journal/2026-07-25-bilan.md` l.40 : « la fausse limite aurait handicapé toutes les boutiques suivantes ».

### A2. « ~60 % de listings morts » = identifiants tronqués et préfixes devinés
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-sourcing-accessoires-v3.md §Notes de méthode]**
- **Symptôme** : ~60 % des IDs AliExpress remontés renvoyaient 404 ; « 5 des candidats les plus prometteurs » morts (`boutique-seiko-mod/journal/2026-07-25-sourcing-familles-v2.md` l.26).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-dsers-mapping-decoupage.md l.41 ; boutique-seiko-mod/journal/2026-07-31-dsers-mapping-lot2.md l.168]** **[NOTION]**
- **Symptôme** : la doctrine attendue (« SKU identiques ⇒ auto-matching », écrite dans `boutique-seiko-mod/journal/2026-07-25-plan-decoupage-coloris.md` l.12 et `boutique-seiko-mod/journal/2026-07-25-catalogue-v2-analyse-concurrents.md` l.111) ne s'est jamais produite : coller l'URL fournisseur rattache le bon produit mais laisse **toutes les variantes vides**.
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-24-build-site.md l.12 ; boutique-seiko-mod/journal/2026-07-31-publication-grappes.md l.29-31]** **[MÉMOIRE : shopify-canal-et-visuels-ia]** **[NOTION]**
...
- **Faux positif connu** : `onlineStoreUrl: null` ne prouve rien tant que le storefront est sous mot de passe (`boutique-seiko-mod/journal/2026-07-25-decoupage-coloris-lot1.md` l.128).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-accessoires-lot4.md l.92-100]** **[NOTION]**
...
- **Recommandé** : paginer explicitement (`media(first:30)` + `pageInfo.hasNextPage`) et **boucler ses totaux** ; quand un chiffre sert de base à une purge, le recompter par une autre voie (contre-exemple propre : `boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md` l.40).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-design-modernisation.md l.178 ; boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md l.9-12 ; boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §6.1]** **[NOTION — les deux générations]**
Évolution tracée, à connaître pour lire les vieux livrables :
1. **Doctrine v1 (25/07) — « rejet silencieux »** : après 90 s d'attente vaine sur un upsert, conclusion « `upsertedThemeFiles: []` ne veut pas dire "en cours", c'est un rejet silencieux ; re-interroger `size`/`updatedAt` » (`boutique-seiko-mod/journal/2026-07-25-design-modernisation.md` l.178-179, reprise au `boutique-seiko-mod/journal/2026-07-25-bilan.md` l.43). Généralisation abusive : le cas déclencheur était en réalité le rejet du champ `custom_css` (B4), pas l'asynchronisme. Toute une passe a refait des écritures qui avaient abouti [NOTION 26/07 : « nous avions traité un comportement normal comme un rejet silencieux »].
2. **Doctrine v2 (26/07) — « écriture asynchrone normale »** : `[]` sans `userErrors` n'est **pas** un échec ; « c'est la relecture des empreintes qui la prouve » (`boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md` l.11 ; réaffirmée les 27 et 30/07).
3. **Raffinements v2 (vérification)** : `size` et `updatedAt` **ne prouvent rien** (en-tête auto-généré de 363 o compté à la lecture mais pas stocké sur certains fichiers, template stocké minifié/renvoyé indenté, horloges divergentes, `updatedAt` bougeant par effet de bord des collections). **Comparer aux octets envoyés, jamais au contenu relu, puis relire pour confirmer** (`boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md` §6.1 ; `boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md` §« le piège de l'empreinte » : recette `rstrip(b'\n')` + md5). Deux restrictions confirmées : `[]` **avec** `userErrors` = vrai rejet (message explicite, `boutique-seiko-mod/journal/2026-07-31-pages-collection-refonte.md` l.52) ; une réponse « connecteur injoignable » n'avait **rien écrit** — détecté par relecture (`boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md` l.23).
...
**[NOTION — passe du 26/07]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.89]**
...
**[NOTION]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.90]**
...
**[NOTION]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.95]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-reprise-editoriale-fiches.md l.41-55]** **[NOTION]**
...
- **Résultat** : les 47 titres ont été **restaurés** ; contrôle ultérieur : 60 titres uniques, 42-67 caractères. Le piège ne s'est pas rejoué (`boutique-seiko-mod/journal/2026-07-31-verification-catalogue-strategie.md` l.156-157 : vérification avant écriture).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-visuels-lot3.md l.28]**
...
**[NOTION — « 31 textes alternatifs détruits en une passe »]** **[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-decoupage-elagage-lot2.md l.10-33 ; boutique-seiko-mod/journal/2026-07-31-reduction-meres-et-galeries.md ; boutique-seiko-mod/journal/2026-07-31-branchement-visuels-lot3.md ; boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md §8.1]**
- **Symptôme** : rattacher une image existante en passant son URL CDN dans `originalSource` ne crée **pas** de copie : Shopify reconnaît l'URL et rattache le **même objet `MediaImage`**. L'`alt` étant une propriété du **fichier**, pas du rattachement, chaque création a réécrit l'alt partagé — **31 alt détruits en une passe** (les 7 mères), réparés via `fileUpdate` avec le titre de la mère, mais **textes d'origine perdus, non récupérables** (`boutique-seiko-mod/journal/2026-07-31-decoupage-elagage-lot2.md`).
- **Sémantique de suppression, établie sur pilote** (`boutique-seiko-mod/journal/2026-07-31-reduction-meres-et-galeries.md`) : malgré son nom, `productDeleteMedia` **détache** quand le fichier est référencé ailleurs (pilote sur 1 média : mère et sœurs intactes ; 181 détachements, 0 suppression) — mais **supprime définitivement** un média non partagé (`boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md` §8.1 : triple vérification de non-partage AVANT de supprimer les 16 médias de plongeuse, sauvegardés d'abord — `boutique-seiko-mod/backups/backup-medias-partages-2026-07-26/` 31 JPEG, `boutique-seiko-mod/backups/backup-medias-plongeuse-supprimes-2026-07-27/` 16 JPEG + MANIFESTE).
- **Nuance vérifiée sur pilote** (`boutique-seiko-mod/journal/2026-07-31-branchement-visuels-lot3.md`) : `productCreateMedia` + `originalSource` sur un fichier déjà en ligne du CDN de la boutique a créé un `MediaImage` **indépendant** (fichier suffixé UUID), alt de la mère intact — vérifier sur pilote avant de généraliser, et poser un `alt` strictement identique par précaution.
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §5 ; boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md §8.1c]**
...
- **Prévention** : avant toute suppression de média, inventorier les liaisons variante→média et réaffecter d'abord ; rappel du thème : sans image liée à la variante, le clic ne change pas la galerie (`boutique-seiko-mod/journal/2026-07-25-plan-lisibilite-variantes.md` l.58). Corollaire du découpage : les **80 médias restés sur les 7 mères en brouillon** sont invisibles en vitrine et jugés non récupérables (0/6 au contrôle visuel — voir D1) (`boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md`).

### B8. Renommer un handle par API ne crée **pas** de redirection
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-publication-grappes.md §7 l.426-510 ; boutique-seiko-mod/journal/2026-07-31-plan-nommage-seo.md l.221-238]**
...
- **Solution** : 5 `urlRedirectCreate` (1 collection + 4 fiches), testées en session (200 sur la nouvelle URL). `boutique-seiko-mod/journal/2026-07-31-plan-nommage-seo.md` prévoit **6 redirections à poser à la main** pour la phase de renommage suivante.
- **Prévention** : tout renommage de handle = redirection explicite + test.

### B9. Les menus Shopify sont partagés entre thèmes
**[NOTION]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.93 ; boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §5.5]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-metachamps-montres.md §1]** **[NOTION]**
...
**[NOTION]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-25-images-modeles-et-coloris.md §1]** **[MÉMOIRE : shopify-canal-et-visuels-ia]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md l.23]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md l.168-191]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md l.96, l.253-257]**
...
- Les images de synthèse « fidèles » restent des extrapolations : contrôler contre la photo fournisseur, et le dire quand la teinte (bronze qui patine) n'est pas garantie (`boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md` §7).
...
**[NOTION — contrôle 6 mères / 6 échecs]** **[FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.92]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-verification-catalogue-strategie.md §5]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §5 ; variantes-logo-supprimees-*.tsv]**
...
- **Solution** : **78 variantes logo supprimées** (272 → 194 ; TSV de sauvegarde acier 61 lignes + bronze 19 lignes, 29/07) après sauvegarde complète ; mapping limité aux coloris `-sterile`. Les 12 variantes GMT « siglé » de la mère `voyageur-gmt-automatique` restent en `DENY`/stock 0, jamais publiées ; 4 cadrans arabes « Logo S » documentés comme **contrefaçon probable, jamais vendus** (`boutique-seiko-mod/journal/2026-07-31-sourcing-configurateur.md` l.226).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-audit-promesses.md ; boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §5 ; boutique-seiko-mod/journal/2026-08-08-reprise-session.md l.77-81]**
...
- « **Plongeuse** » dans 3 titres Héritage alors qu'elles sont à 5 bar (nage exclue) — requalifié en « style plongeuse » dans les corps de texte et le SEO (`boutique-seiko-mod/journal/2026-07-25-reprise-editoriale-fiches.md` l.238).
- 11 fiches promettaient « 10 bar : douche, piscine et baignade sans souci » (`boutique-seiko-mod/journal/2026-07-31-audit-promesses.md` l.166) ; saphir/904L non prouvés fournisseur ; chronos « automatiques » alors que le **VK63 est méca-quartz à pile** — toute formule globale devient fausse dès qu'un chrono entre au catalogue : vérifier la nature du mouvement **par famille**. [NOTION]
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-verification-catalogue-strategie.md §1]**
- **Symptôme** : la mesure SEMrush avait assimilé « squelette » à notre « fond verre » (`boutique-seiko-mod/journal/2026-07-31-mots-cles-semrush.md` l.222 — rangé lui-même en « supposé », pas mesuré). Vérification sur pièces : **0 fiche sur 53** — « fond verre » est une valeur d'option de *fond de boîtier*, jamais un cadran ; les 53 visuels ont un cadran plein ; recherche plein texte 0 occurrence (validée par mot témoin `cramoisi`).
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md l.166-199 ; boutique-seiko-mod/journal/2026-07-31-charte-ab-application.md]** **[NOTION]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-mots-cles-semrush.md §0 ; boutique-seiko-mod/journal/2026-07-31-marche-complet-semrush.md §0]**
...
**[NOTION]**
- Orchestrateur et agents se marchent dessus sur le même Chrome : **sérialiser**, ou utiliser deux navigateurs distincts (navigateur intégré / Chrome). Corollaire du 29/07 : la session Chrome peut être **sur le mauvais compte** (contrôle DSers reporté pour cette raison — `boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md` l.10).

### E4. Iframes cross-origin d'admin : non pilotables
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-metachamps-montres.md]** **[MÉMOIRE : import-avis-trustoo-bookmark, mobile-first-et-placeholders-demo]**
...
**[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-publication-grappes.md §7]**
...
4. **« Techniquement impossible » n'est une doctrine qu'après revalidation dans d'autres conditions.** Deux fausses limites inscrites puis corrigées (CAPTCHA AliExpress, 60 % de listings morts) ; `boutique-seiko-mod/journal/2026-07-25-journal-nuit-suite.md` : « une fausse limite coûte plus cher qu'une passe de plus ». Symétriquement, une **vraie** limite documentée (iframe cross-origin, gommage impossible) épargne des heures — d'où l'importance de distinguer les deux par la preuve.
