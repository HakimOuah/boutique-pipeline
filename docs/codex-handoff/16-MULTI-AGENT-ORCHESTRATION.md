...
|---|---|---|
| Correcteur thème **JSON** | `boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md` | 5 fichiers `config/` + `templates/` — « Aucun `.liquid`, aucun `assets/` » |
| Correcteur thème **assets** | `boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md` | « `assets/` uniquement — 1 CSS + 6 JS. Aucun `.json`, aucun `.liquid` » |
| Correcteur thème **Liquid** | `boutique-seiko-mod/journal/2026-07-31-fix-uiux-liquid.md` | 10 fichiers `.liquid` — « Aucun `.json`, aucun `assets/` » |
| Brancheur de galeries | `boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md` | uploads + rattachements médias, **0 média supprimé** |
| Sourceur de grappes | `boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md` | 5 fiches DRAFT, « aucune fiche existante touchée » |
| Vérificateur de véracité | `boutique-seiko-mod/journal/2026-07-31-verification-catalogue-strategie.md`, `boutique-seiko-mod/journal/2026-07-31-fiches-contradictoires-et-cadran-arabe.md` | lecture + passage en DRAFT, aucune suppression |
| Auditeurs UI/UX (lecture seule) | `boutique-seiko-mod/journal/2026-07-31-audit-uiux-home.md`, `boutique-seiko-mod/journal/2026-07-31-audit-uiux-produit.md`, `boutique-seiko-mod/journal/2026-07-31-audit-uiux-panier.md` | constat pur, aucune écriture |
| Passe de cohérence finale | `boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md` | mesure tout, ne corrige que son mandat |
...
Noirmont** — Codex générateur d'images en local, contrat écrit `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md`, interdiction
absolue de toucher Shopify, branchement resté côté Claude Code : **85 fiches, 206 médias**
[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md]. Le 31/07 au matin ce rôle avait été
...
à lire d'abord**. Trace canonique : `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md` s'ouvre sur « Il est autoportant », décrit
le catalogue (92 fiches, 85 à traiter) et renvoie à `boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md`, désigné « feuille de
route de Codex » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md l.6]. Les briefs internes font
pareil : `boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md` cite ses sources (`boutique-seiko-mod/journal/2026-07-31-audit-uiux-home.md`, `boutique-seiko-mod/journal/2026-07-31-audit-uiux-panier.md`).
...
Aucun `.json`, aucun `.liquid`, aucun `snippets/` » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md] ;
« Hors des 6 points confiés : **non appliqué**, soumis à arbitrage »
[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md].

### 2.3 Interdits ⛔ explicites

Toujours une section d'interdits absolus, en tête. `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md` : « Ne te connecte pas à
Shopify […] Ne modifie aucun SKU […] N'invente aucune caractéristique produit […] Pas d'inpainting »
[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md]. Le même patron est devenu la section « ⛔
...
- « La dernière fois, le manifeste était indexé sur des **identifiants de variante devenus périmés avant
  ...
  [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md §Nommage].
...
- Le bloc « MANDATORY ORIENTATION » né des deux échecs d'orientation du chantier aviateur, réinjecté dans
  les prompts suivants [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md l.253-257 ;
  boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §4 « bloc MANDATORY ORIENTATION renforcé »].
...
empreinte. `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md` §13 : planche par famille, planche de zoom des cadrans,
...
relecture MD5 après chaque écriture de thème [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-liquid.md,
boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md].
...
`03` §3, et le « Rapport final : le décompte réel par bloc… » de `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md` §13].
...
[FAIT — repo:boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §4.3 « domaine réservé de Hakim —
...
1. **Jamais deux agents sur les mêmes fichiers.** L'exemple canonique est le découpage du chantier thème
   du 26/07 en trois agents étanches par **type de fichier** : JSON (`boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md`) / assets CSS+JS
   (`boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md`) / Liquid (`boutique-seiko-mod/journal/2026-07-31-fix-uiux-liquid.md`). Chaque livrable déclare et prouve son étanchéité
   (tables d'empreintes disjointes), et `boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md` note explicitement que « le travail des agents
...
2. **Le navigateur est une ressource unique.** Leçon de la nuit du 25/07 : « Deux consommateurs simultanés
   ...
   parce qu'un agent de sourcing naviguait [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-journal-nuit.md §Enseignements].
   ...
   « session Chrome sur le mauvais compte ») [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md l.10].
...
|---|---|---|---|---|
| **0 — immédiate** | arborescence produit (liste fermée), persona & objections, charte + squelettes de pages | kick-off fait (00 : store créé par Hakim — dépend du « Produit validé GO ») | 00b, 02, 03 — tous trois ne dépendent que de 00, donc **parallélisables** | `boutique-seiko-mod/journal/2026-07-24-arborescence-site.md` ; `personas/persona-noirmont-2026-07-25.md` ; `boutique-seiko-mod/journal/2026-07-25-charte-noirmont.md` |
| **1 — après validation produit** | sourcing AliExpress détaillé (liens `/item/`, prix rendus, délais) | arborescence **validée par Hakim** (01 dépend de « 00b (arborescence validée) ») | 01 | `boutique-seiko-mod/journal/2026-07-24-fournisseurs-reponses.md`, sourcing phase4b/c/d du 24/07 |
| **2 — après choix fournisseur** | import DSers (mapping intact), canal + collections + menus, francisation des variantes, prix ×1,3 | fournisseurs arrêtés | 04 → 05 et 06 (les deux dépendent de 04) → 07 (dépend de 06) | `boutique-seiko-mod/journal/2026-07-25-dsers-mapping-decoupage.md`, `boutique-seiko-mod/journal/2026-07-25-decoupage-coloris-lot1.md`, `boutique-seiko-mod/journal/2026-07-31-publication-grappes.md` |
| **3 — après visuels** | génération d'images (Codex), branchement galeries + images de variantes, PDP, homepage, avis, panier | charte validée + catalogue en place (08 dépend de 03+05 ; 09 de 02+03+07 ; 10 de 02+03+08 ; 12b de 05+09+13) | 08, 09, 10, 11, 12, 12b | `boutique-seiko-mod/journal/2026-07-31-prompt-codex-galeries.md` → `boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md` (26/07, 85 fiches/206 médias) ; `boutique-seiko-mod/journal/2026-07-25-journal-nuit.md` (24 visuels → 120 variantes) |
| **4 — finale** | livraison, pages légales, réglages, QA mobile-first, passe de cohérence, clôture — puis **validation humaine de publication** | tout le contenu posé (16 dépend de 09,10,11,12,13,14,15 ; 17 de 16) | 13, 14, 15 → 16 → 17 | `boutique-seiko-mod/journal/2026-07-31-pages-legales-et-delais.md`, `boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md`, `boutique-seiko-mod/journal/2026-08-08-reprise-session.md` §Ce qui attend Hakim |
...
- **La barrière finale n'a jamais été franchie** : Noirmont est restée sous mot de passe, thème UNPUBLISHED —
  la publication est un gate Hakim, pas une étape d'agent [FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md].
- Les vagues **se re-déclenchent** : chaque découverte de véracité (fiches contradictoires du 27/07,
  ...
  barrières [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fiches-contradictoires-et-cadran-arabe.md,
  boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md].
...
- **Exiger des mesures, refuser les déductions.** Deux constats de contraste se sont contredits sur le même
  ...
  [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md §Contraste du bandeau]. Dans l'autre sens, le balayage du
  coordinateur a pris en défaut la correction d'un agent : 5,6:1 annoncé (calculé sur `color`), **1,28:1 réel**
  sur schéma sombre — refaite et mesurée [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md §Contraste du
...
- **Mots-clés témoins.** SEMrush à quota épuisé rend « Tous les mots clés : 0 » **sans erreur** — quatre
  ...
  massif validé dans la même session [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-mots-cles-semrush.md §0 ;
  boutique-seiko-mod/journal/2026-07-31-marche-complet-semrush.md §0].
- **Croiser deux agents sur le même objet quand le doute existe.** La passe de cohérence a re-balayé ce que
  ...
  signalement » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §8.2].
- **Un chiffre qui fonde une purge se recompte par une autre voie.** Inventaire de purge : 173 photos
  ...
  l'inventaire, 13 photos auraient survécu [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-accessoires-lot4.md
  l.92-100 ; `10` A6].
...
- **Règle n°1 : « établis l'état réel par des mesures avant d'agir. »** La reprise du 29/07 au soir en est
  ...
  re-QA, **0 crédit reperdu** [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §5].
- **Idempotence** : ne pas régénérer ce qui existe, ne pas re-supprimer ce qui l'est déjà. Les prompts de
  ...
  [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-archive-prompt-reprise-visuels.md.bak] ; le protocole d'ordres
...
- **Relais des verdicts entre agents qui ne peuvent pas se joindre** : le QA partiel de l'agent interrompu a
  ...
  mécanisme vers Hakim endormi [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-journal-nuit.md, -suite.md].
...
- **La preuve prime, et chaque type de vérité a sa preuve** : l'identité produit se prouve par la **chaîne
  ...
  les fiches qui sont mal conçues ») [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fiches-contradictoires-et-cadran-arabe.md §1] ;
...
- **Un agent qui refuse une autorisation mal fondée a raison** (`10` F5). Deux cas réels au-delà des refus
  ...
  1. Autorisation de supprimer 16 médias **conditionnée à une sauvegarde** : « Aucune sauvegarde locale
     ...
     [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md §8.1].
  2. Ordre de masquer les étoiles d'avis (`aria-hidden`) « **si** la note chiffrée est affichée à côté » :
     ...
     [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fix-uiux-assets.md §Étoiles d'avis].
...
- **Sur l'irréversible et le domaine réservé : signaler + proposer + attendre.** Le badge « 1340 avis »
  ...
  corriger plutôt que le retirer » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-passe-coherence-avant-publication.md §4.3].
  Idem le sort des 6 faces SWISS MADE : « l'arbitrage (regénérer ? retoucher ? masquer ?) t'appartient »
  [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md l.144].
- **Trancher seul le réversible, en le journalisant** : passages en DRAFT (réversibles, sauvegardés) décidés
  ...
  [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-fiches-contradictoires-et-cadran-arabe.md, en-tête].
...
- **`boutique-seiko-mod/journal/2026-08-08-reprise-session.md` = l'état consolidé toujours à jour** : l'orchestrateur y reverse ce qui survit aux
  sessions (état, pièges, « ce qui attend Hakim ») ; c'est le premier fichier de toute reprise
  [FAIT — repo:boutique-seiko-mod/journal/2026-08-08-reprise-session.md ; règle de lecture dans `12` §1].
- **Les corrections aux briefs de l'orchestrateur sont consignées par les agents eux-mêmes** — le flux
  ...
  en donne **11** » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-seo-titles-produits.md §6] ; « ⚠️ **36, et non 31.** Le
  chiffre de 31 qui figure dans le prompt vient de la version 1 de cet audit […] C'est ce document qui fait
  foi » [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md l.234] ; la fiche mémoire disait « 18
...
def vague(nom, briefs, apres=None):
    ...
    fusionner(resultats, dans="boutique-seiko-mod/journal/2026-08-08-reprise-session.md")            # état consolidé
    return resultats
...
- **Le duo « Codex génère / Claude contrôle et branche »** : 230 générations exécutées par Codex sur
  ...
  écartées au contrôle [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-branchement-galeries-codex.md ; `03` §8].
...
- **La reprise état-d'abord qui a sauvé 92 crédits** [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §5].
...
1. **Des briefs de l'orchestrateur factuellement faux, corrigés par les agents.** « 9 fiches sans
   diamètre » → 11 réelles [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-seo-titles-produits.md §6] ; « 31 faces
   sources » → 36 [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md l.234] ; « 18 tickets » en
...
2. **Une consigne trop large qui aurait rendu le produit infidèle.** La règle de stérilité, lue comme
   ...
   [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-visuels-aviateur-consolidation.md §1]. Même famille d'erreur : la tâche
   ...
   [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-bilan.md §Ce qui reste, point 4] ; et l'ambiguïté « chiffres
...
3. **Une collision de briefs évitée de justesse : deux prompts Codex concurrents.** Après l'arbitrage du
   ...
   boutique-seiko-mod/journal/2026-07-31-audit-visuel-catalogue.md l.318 ; boutique-seiko-mod/journal/2026-07-31-obsolete-ne-pas-utiliser-prompt-galeries-v1.md.bak]. Leçon : un brief
...
4. **Un faux diagnostic d'orchestration qui a coûté une passe entière** : la doctrine `upsertedThemeFiles: []`
   ...
   repo:boutique-seiko-mod/journal/2026-07-25-design-modernisation.md l.178, boutique-seiko-mod/journal/2026-07-31-fix-uiux-json.md l.9-12].
5. **Les interruptions machine, et le protocole né d'elles** : génération interrompue faute de crédits
   (25/07) [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-archive-prompt-reprise-visuels.md.bak], runbook non
   inscriptible en pleine nuit (droits macOS) [FAIT — repo:boutique-seiko-mod/journal/2026-07-25-journal-nuit.md,
   en-tête], agent tué en pleine mission (29/07) [FAIT — repo:boutique-seiko-mod/journal/2026-07-31-sourcing-arabes-squelettes.md §5].
   Réponse systémique : `boutique-seiko-mod/journal/2026-08-08-reprise-session.md` en tête de dossier, prompts de reprise « ce qui est déjà
...
5. Mettre à jour `boutique-seiko-mod/journal/2026-08-08-reprise-session.md` (ou l'équivalent boutique) **avant** de clore la session — c'est le
...
- L'état consolidé (`boutique-seiko-mod/journal/2026-08-08-reprise-session.md` / `project-state.md`) reversé à chaque session significative,
