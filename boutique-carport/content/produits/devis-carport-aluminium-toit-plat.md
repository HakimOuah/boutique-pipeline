# Fiche produit sur devis — Carport aluminium toit plat sur mesure, 1 ou 2 voitures

*Fusionne les fiches prix fixe `carport-aluminium-2-voitures-toit-plat`, `carport-aluminium-1-voiture` et `carport-polycarbonate` (fabricants Star Alu sur devis, voir `FOURNISSEURS-DEVIS.md`). Archivées dans `_archive-prix-fixe/`. Copy conforme à `CHARTE-COPY-2026-09-10.md`.*

**Mot-clé principal :** carport alu 2 voitures
**Mots-clés secondaires :** carport toit plat alu, carport toit plat 2 voitures, carport aluminium 1 voiture, carport polycarbonate
**Meta title (≤60) :** Carport toit plat alu sur mesure, devis 48 h | Sous Abri
**Meta description (≤155) :** Carport aluminium toit plat à vos cotes, 1 ou 2 voitures, polycarbonate au choix, testé à 122 km/h, garantie fabricant 5 ans. Devis 48 h, livré offert.
**Collections :** carport alu, carport 2 voitures, carport 1 voiture, carport toit plat, carport métallique (pour le mot polycarbonate)

## H1
Carport aluminium toit plat sur mesure, 1 ou 2 voitures

## Sous-titre
Des lignes contemporaines qui s'accordent à la maison, une toiture polycarbonate qui laisse passer la lumière, une ou deux voitures au sec côte à côte. Fabriqué à vos cotes exactes en aluminium 6063-T5, dans votre coloris. Envoyez-nous vos dimensions, vous recevez un prix ferme livraison comprise sous 48 h.

## Bloc d'achat (remplace le panier)
- Toit plat en aluminium 6063-T5 thermolaqué, autoportant, pour 1 ou 2 voitures côte à côte ; structure en gris mat, champagne, brun mat ou blanc
...
Longueur et largeur souhaitées (m) · hauteur de passage souhaitée (m) · 1 ou 2 voitures · toiture (polycarbonate transparent ou teinté, polycarbonate granité, tuile aluminium, panneau insonorisant) · coloris de la structure (gris mat, champagne, brun mat, blanc) · nature du sol (terre, dalle béton, enrobé) · code postal · photo de l'emplacement (facultatif) · e-mail et téléphone · case « j'ai lu que ce carport nécessite en général une déclaration préalable en mairie ».
...
Parce que ce carport est fabriqué pour vous : à vos dimensions, pour une ou deux voitures, dans votre coloris et avec la toiture que vous choisissez, par notre atelier partenaire. Le prix suit la surface couverte, le nombre de voitures, la toiture et la finition ; le devis vous donne un chiffre ferme, livraison comprise, sans engagement et sans paiement avant votre accord.

### Ce que vous choisissez
Le nombre de voitures (1 ou 2 côte à côte) et les dimensions, hauteur de passage comprise ; la toiture selon que vous cherchez la lumière ou l'ombre : polycarbonate plein de 2 ou 3 mm (bleu lac, transparent, ambre, gris clair ou gris foncé), polycarbonate granité, tuile aluminium ou panneau insonorisant ; le coloris de la structure aluminium, gris mat, champagne, brun mat ou blanc, pour s'accorder à la façade.

### Faut-il le déclarer ?
Oui dans presque tous les cas, et c'est simple : dès 5 m² d'emprise au sol, une déclaration préalable en mairie ; au-delà de 20 m², un permis de construire. Pour deux voitures côte à côte, prévoyez le permis de construire ; pour une voiture seule, cela dépend des dimensions retenues. Votre devis rappelle le seuil qui s'applique aux vôtres, notre guide déclaration vous accompagne pas à pas, et votre mairie vous confirme le régime applicable. Déposez votre dossier avant de valider le devis : le carport arrive une fois l'autorisation en poche.

### Le montage, à deux
Prévoyez d'être deux et réservez une demi-journée à un week-end selon la surface. La notice du fabricant guide chaque étape, et notre guide de montage offert ajoute l'ordre conseillé et les points de contrôle. Comme pour toute structure aluminium-polycarbonate, prévoyez une à deux cartouches de silicone pour parfaire l'étanchéité des jonctions de toiture : un cordon sur chaque jonction, et le toit est étanche dès la première pluie.
...
## FAQ (8)
**1. Deux voitures rentrent-elles vraiment côte à côte ?** Oui : vous indiquez « 2 voitures » dans le formulaire, et nous confirmons dans le devis une largeur qui laisse ouvrir les portières des deux côtés.
**2. Puis-je avoir un prix indicatif avant de remplir le formulaire ?** Le prix suit la surface, le nombre de voitures et la toiture choisie ; en remplissant le formulaire, vous recevez sous 48 h un chiffre ferme, livraison comprise, sans engagement.
...
## Images (ALT et rôle)
1. Carport aluminium toit plat monté devant une maison, une ou deux voitures dessous (désir).
2. Schéma coté avec les champs du formulaire, longueur/largeur/hauteur de passage (compréhension).
3. Détail de la toiture polycarbonate et de la structure aluminium (matière).
4. Fondations et fixations des pieds au sol (ancrage).
5. Nuancier des toitures polycarbonate (transparent, teinté, opaque) et des coloris de structure (choix).
