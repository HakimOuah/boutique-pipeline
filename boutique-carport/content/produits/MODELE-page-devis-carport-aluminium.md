...
Pourquoi : 5 des 7 fiches alu chinoises sont des fabricants sur devis (voir `FOURNISSEURS-DEVIS.md`). Une page « prix fixe + panier » y est impossible : le prix affiché sur AliExpress est un échantillon ou un mètre carré. Ce modèle remplace les fiches `carport-aluminium-2-voitures-toit-plat`, `carport-aluminium-adosse`, `carport-aluminium-1-voiture`, `carport-polycarbonate` et `carport-autoportant-2-pieds-aluminium` par trois pages de devis (toit plat 1–2 voitures · adossé · cintré 2 pieds), avec le même bloc de formulaire. Exemple rédigé sur le carport cintré 2 pieds (fiche ONE ALU, captures Hakim du 09/09). Copy conforme à `CHARTE-COPY-2026-09-10.md`.

**Mot-clé principal :** carport aluminium sur mesure
**Meta title (≤60) :** Carport aluminium sur mesure, devis sous 48 h | Sous Abri
**Meta description (≤155) :** Carport aluminium cintré 2 pieds à vos cotes, coloris et toiture au choix, testé à 122 km/h, garantie fabricant 5 ans. Devis ferme sous 48 h, livré offert.

## H1
Carport aluminium cintré 2 pieds, sur mesure

## Sous-titre
Le côté voiture reste entièrement libre : vous ouvrez les portières sans poteau devant vous. Fabriqué à vos cotes exactes en aluminium 6063-T5, dans votre coloris. Envoyez-nous vos dimensions, vous recevez un prix ferme livraison comprise sous 48 h.
...
Longueur et largeur souhaitées (m) · hauteur de passage souhaitée (m) · 1 ou 2 voitures · autoportant ou adossé à un mur · toit plat, monopente ou cintré · coloris de la structure (gris mat, champagne, brun mat, blanc) · toiture (polycarbonate transparent ou teinté, polycarbonate granité, tuile aluminium, panneau insonorisant) · nature du sol (terre, dalle béton, enrobé) · code postal · photo de l'emplacement (facultatif) · e-mail et téléphone · case « j'ai lu que ce carport nécessite en général une déclaration préalable en mairie ».
...
Parce que ce carport est fabriqué pour vous : à vos dimensions, dans votre coloris, avec la toiture que vous choisissez, par notre atelier partenaire. Le prix suit la surface, la hauteur, le type de toit et la finition ; le devis vous donne un chiffre ferme, livraison comprise, sans engagement et sans paiement avant votre accord.

### Ce que vous choisissez
Les dimensions et la hauteur de passage, adaptées à votre véhicule et à votre allée ; le toit cintré à deux pieds, qui laisse le côté voiture libre pour ouvrir les portières ; le coloris de la structure (gris mat, champagne, brun mat ou blanc) pour s'accorder à la façade ; la toiture selon que vous cherchez la lumière ou l'ombre : polycarbonate plein de 2 ou 3 mm (bleu lac, transparent, ambre, gris clair ou gris foncé), polycarbonate granité, tuile aluminium ou panneau insonorisant.
...
## FAQ (8)
Puis-je avoir un prix indicatif avant de remplir le formulaire ? (le prix suit la surface, la hauteur, le type de toit et le coloris ; le formulaire donne sous 48 h un chiffre ferme, livraison comprise, sans engagement) · Le devis m'engage-t-il ? (non, gratuit et sans engagement) · Combien de temps est-il valable ? (30 jours, puis nouveau devis à jour) · Puis-je changer les dimensions après le devis ? (oui jusqu'au lancement de la fabrication ; ensuite le carport est découpé à vos cotes, qui sont figées) · Que se passe-t-il si ma mairie refuse ? (annulation sans frais tant que la fabrication n'est pas lancée ; ensuite le carport est fabriqué à vos cotes et ne relève pas du droit de rétractation, article L221-28 du Code de la consommation ; conseil : déposer la déclaration en mairie avant de valider le devis, valable 30 jours) · Livrez-vous et montez-vous ? (livraison offerte sur rendez-vous ; montage à deux avec la notice du fabricant et notre accompagnement par e-mail) · Le polycarbonate jaunit-il ? (toiture faite pour l'extérieur : testée par le fabricant de −40 à +120 °C, classée ignifuge B1, 250 à 300 fois plus résistante aux chocs que le verre ; garantie fabricant 5 ans) · Puis-je payer en plusieurs fois ? (oui, 3 fois avec Klarna ou 4 fois avec PayPal selon le montant et les conditions de ces services ; paiement sécurisé).
