...
1. **Photo d'ambiance (désir) :** carport aluminium brun au toit cintré abritant un fourgon aménagé, ciel gris
2. **Vue d'ensemble (compréhension) :** carport 6x3,8 m vu de trois quarts, toit incurvé en polycarbonate, structure ouverte
...
5. **Plan coté (dimensions) :** schéma technique 6x3,8 m, hauteur sous poutre 2,50 m
