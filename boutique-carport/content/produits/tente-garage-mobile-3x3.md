...
Tente de garage mobile 3 × 3 m, porte enroulable
...
- 3 × 3 m au sol, un format compact pour une voiture, deux motos ou un espace de rangement
- Cadre tubulaire galvanisé et bâche PE
- Une porte enroulable
...
Le montage se fait à deux ; sur ce format compact, comptez environ 2 heures, un peu moins que sur une tente de 4 × 6 m. Lisez la notice en entier avant de commencer : un montage à blanc (pièces posées sans serrage définitif) permet de vérifier l'alignement avant de tout fixer. [À VÉRIFIER : durée exacte constatée, liste des outils nécessaires].

### L'ancrage et le vent

[À VÉRIFIER : contenu exact du kit d'ancrage fourni — piquets, haubans]. Sur un sol meuble, les piquets fournis suffisent en général. Sur une dalle, de l'enrobé ou du béton (garage extérieur, cour bétonnée), prévoyez un ancrage complémentaire : sacs de sable aux angles, plots à visser ou chevilles adaptées au support. Par vent fort, fermez la porte enroulable : une tente ouverte prend le vent comme une voile. [À VÉRIFIER : résistance au vent en km/h annoncée par le fournisseur] — nous ne l'affichons pas tant qu'elle n'est pas confirmée.

### Ce qu'il ne fait pas

Une bâche PE n'est pas éternelle : selon l'exposition au soleil et au vent, la durée de vie constatée sur ce type de produit va de 2 à 6 ans avant de devoir être remplacée. [À VÉRIFIER : bâche de rechange disponible séparément, grammage]. Le fournisseur mentionne une charge de neige testée sans donner de chiffre : nous vous conseillons de retirer la neige du toit régulièrement plutôt que de compter sur une résistance non précisée. Ce n'est pas un système de sécurité contre le vol : c'est une toile sur une structure légère, pas un mur en dur.
...
| Hauteur | [À VÉRIFIER] |
| Portes | 1 porte enroulable |
| Surface au sol (calcul indicatif) | ≈ 9,3 m² |

Conseil : ajoutez environ 60 cm à la longueur et à la largeur de votre véhicule ou de vos motos pour circuler autour et fermer la porte sans forcer.

## Caractéristiques

| Caractéristique | Détail |
|---|---|
| Cadre | Tubulaire galvanisé |
...
Nous ne communiquons pas de chiffre tant qu'il n'est pas confirmé par le fournisseur [À VÉRIFIER]. Fermez la porte par vent fort et renforcez l'ancrage si votre terrain est exposé.
...
Comptez environ 2 heures à deux, un format plus rapide à monter qu'une tente 4 × 6 m [À VÉRIFIER : durée exacte].
...
Oui, mais les piquets seuls ne tiennent pas sur une surface dure : prévoyez des sacs de sable aux angles ou des plots à visser adaptés au support.

---

## Meta et ALT — 6 images prévues

1. **Hero désir (16:9)** — ALT : Tente de garage mobile 3x3 m grise montée dans une cour, une voiture à l'abri
2. **Compréhension produit (1:1)** — ALT : Tente de garage mobile 3x3 m vue de face avec sa porte enroulable
3. **Montage (4:3)** — ALT : Deux personnes assemblant le cadre tubulaire galvanisé d'une tente de garage mobile 3x3 m
4. **Ancrage (4:3)** — ALT : Gros plan sur un piquet d'ancrage renforcé par un sac de sable au pied de la tente mobile
5. **Dimensions cotées (schéma)** — ALT : Schéma coté de la tente de garage mobile 3x3 m
6. **Livraison (4:3)** — ALT : Colis compact de la tente de garage mobile livré sur palette en bordure de trottoir
