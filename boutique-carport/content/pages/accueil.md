...
- Ancrage et montage expliqués avant l'achat

**CTA — option 1 (retenue par le brief §Marque, ton, promesse) :** Voir les carports
**CTA — option 2 (alternative à tester) :** Trouver mon carport

*Note pour Hakim : « Voir les carports » est l'action dominante imposée par le brief (une seule action par page). « Trouver mon carport » suppose un sélecteur par famille/dimension pas encore construit — à ne retenir que si un filtre ou un quiz est développé, sinon garder l'option 1. [À DÉCIDER]*
...
Vous avez une maison avec une allée ou une cour, mais pas de garage libre. La voiture prend la pluie, le gel, la grêle, le pollen au printemps. Un carport en dur coûte cher et prend des mois de travaux ; une bâche et deux sardines ne tiennent pas un hiver.

**Situation 2 — une voiture à laquelle vous tenez**
Voiture neuve, électrique, ou simplement soignée : la peinture qui cuit au soleil, le vernis qui part, l'intérieur qui souffre des UV. Vous cherchez un abri correct, pas « une cagette » posée devant chez vous.

**Situation 3 — vous hésitez à cause de la mairie**
Avant même de choisir un modèle, la question revient : a-t-on le droit de poser ça sans déclaration ? Est-ce que ça augmente les impôts ? Cette incertitude arrête plus d'acheteurs que le prix lui-même.

---

## 3. Mécanisme / promesse — 4 cartes

**Carte 1 — On répond à la question mairie avant votre achat**
Chaque fiche indique l'emprise au sol du modèle et si une déclaration préalable ou un permis de construire s'applique en général. Un guide numérique détaille la démarche complète, mairie par mairie.

**Carte 2 — L'ancrage et le vent, expliqués, pas éludés**
Ce qui est fourni pour fixer le carport au sol, et ce qu'il faut prévoir selon votre sol (terre, dalle, enrobé), est écrit sur la fiche, pas découvert à l'ouverture du carton.

**Carte 3 — Le montage, avec une durée réelle**
Quand elle est connue, la durée de montage à deux personnes est indiquée, avec les outils à prévoir. Pas de promesse de « 30 minutes » non vérifiée.

**Carte 4 — La livraison, mise en scène avant l'achat**
Poids, nombre de colis, camion, rendez-vous, bordure de trottoir : vous savez ce qui vous attend le jour J, pas seulement le délai.
...
En résumé, sous réserve de vérification auprès de votre mairie :
...
- **Taxe d'aménagement** : possible pour une surface close et couverte ; un carport ouvert en est souvent exempté, mais c'est la mairie qui tranche.
...
## 6. Comparaison honnête

**Titre de section :** Carport alu, tente-garage, GSB ou garage en dur : comment choisir
...
*Ce tableau compare des usages différents, pas seulement des prix : une tente-garage est un abri temporaire ou d'appoint, un carport aluminium une structure durable, un garage en dur un investissement immobilier. Nous vendons les deux premiers, en le disant clairement.*
...
**Pourquoi c'est plus cher qu'en grande surface de bricolage ?**
Nous répondons avant l'achat aux questions qu'une fiche GSB laisse sans réponse : déclaration, ancrage, montage, livraison. Le prix reflète cet accompagnement, pas seulement l'objet.

---

## 9. CTA final

**Titre :** Trouvez le carport qui protège votre voiture, sans mauvaise surprise à la livraison.

**CTA :** Voir les carports

---

## Images — ALT et rôle de vente (5–6 visuels composés, jamais la photo AliExpress brute)

1. Carport aluminium toit plat monté devant un pavillon, voiture grise dessous, temps couvert — ALT « Carport aluminium 2 voitures toit plat installé devant une maison » — rôle : désir / crédibilité (photo réelle, pas de rendu)
2. Gros plan sur un point d'ancrage au sol (plot béton, fixation) — ALT « Ancrage au sol d'un carport, plot béton » — rôle : compréhension / réassurance technique
3. Montage à deux personnes, pièces numérotées visibles — ALT « Montage à deux d'un carport en kit, pièces numérotées » — rôle : lever le frein montage
4. Camion de livraison et colis en bordure de trottoir — ALT « Livraison d'un carport en kit, colis en bordure de trottoir » — rôle : lever le frein livraison
5. Schéma coté avec dimensions et hauteur de passage — ALT « Schéma coté d'un carport aluminium avec dimensions » — rôle : aide à la décision (dimensions)
6. Tente-garage montée avec portes ouvertes, voiture à l'intérieur, jour de pluie — ALT « Tente-garage fermée protégeant une voiture sous la pluie » — rôle : désir (bénéfice pluie/grêle)
