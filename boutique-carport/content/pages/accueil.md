...
Copy source : `boutique-carport/BRIEF-COPY.md` · `personas/persona-carport-2026-09-09.md` (persona VALIDÉ le 09/09/2026) · **`content/CHARTE-COPY-2026-09-10.md` (charte copy vendeur, rassurant, expert : fait loi depuis le 10/09/2026)** · faits : `content/FAITS-FOURNISSEURS-2026-09-10.md`. Structure calquée sur `boutique-cosycathouse/content/home.md` (9 sections). Sections avis/notes : **laissées vides, chasse gardée de Hakim, ne pas remplir.**

**Mot-clé principal :** carport aluminium
**Meta title (≤60) :** Sous Abri — Carports aluminium & tentes-garages en kit (48 car.)
**Meta description (≤155) :** Carports aluminium, acier et tentes-garages en kit, livrés offerts en France. Sélection vérifiée, guides déclaration et montage offerts, conseil d'expert. (154 car.)
**H1 :** Votre voiture au sec et à l'ombre, toute l'année
...
- Livraison offerte en France métropolitaine, Corse comprise
- Guides déclaration et montage offerts
- Paiement en 3 ou 4 fois avec Klarna et PayPal

**CTA principal :** Voir les carports
**CTA secondaire :** Demander un devis sur mesure

*Une seule action dominante par page (brief §Marque, ton, promesse) : « Voir les carports ». Le CTA secondaire renvoie vers la page devis.*

---

## 2. Douleur — « Votre voiture est dehors, et la prochaine grêle ne prévient pas »

**Surtitre :** Pourquoi un abri voiture
**Titre de section :** Votre voiture est dehors, et la prochaine grêle ne prévient pas

**Situation 1 — pas de garage, une allée qui ne demande qu'à servir**
Vous avez une maison avec une allée ou une cour, mais pas de garage libre. La voiture prend la pluie, le gel, la grêle, le pollen au printemps. Un abri en kit se pose sans travaux de gros œuvre : une tente-garage vous met à l'abri dès ce week-end, un carport aluminium ou acier est un investissement durable qui valorise la maison.

**Situation 2 — une voiture à laquelle vous tenez**
Voiture neuve, électrique, ou simplement soignée : sous un abri, la peinture ne cuit plus au soleil, le vernis garde son éclat, l'intérieur est préservé des UV. Votre voiture reste au sec et à l'ombre toute l'année, et sa valeur de revente avec.

**Situation 3 — la question de la mairie**
Avant même de choisir un modèle, la question revient : faut-il déclarer ? Sous Abri y répond sur chaque fiche, avec l'emprise au sol du modèle et la démarche qui s'applique, et le guide déclaration offert vous accompagne pas à pas.

**Texte retenu pour le thème (bloc unique) :** Une allée, une cour, mais pas de garage libre : la voiture prend la pluie, le gel, la grêle, le pollen, et la peinture cuit au soleil. Un abri en kit change la donne. Votre voiture reste au sec et à l'ombre toute l'année, sa carrosserie et son intérieur gardent leur éclat, et sa valeur de revente avec. Une tente-garage vous met à l'abri dès ce week-end ; un carport aluminium ou acier est un investissement durable qui valorise la maison.

**Lien :** Carport ou tente-garage : comment choisir → `comparatif-carport-tente-garage`

---

## 3. Mécanisme — « Ce que Sous Abri fait pour vous », 4 cartes

**Surtitre :** Ce que Sous Abri fait pour vous
**Titre de section :** Tout est prévu, du choix du modèle au montage

**Carte 1 — Une sélection vérifiée**
Chaque modèle est contrôlé avant d'entrer au catalogue : cotes, kit d'ancrage, contenu des colis. Vous choisissez parmi des abris que nous connaissons.

**Carte 2 — Des guides offerts**
Déclaration en mairie, montage et ancrage : deux guides numériques offerts pour poser votre abri dans les règles et sans hésitation, avec ce qu'il faut prévoir selon votre sol (terre, dalle, enrobé).
...
**Titre de la grille :** Nos abris voiture
...
**Bloc tentes-garages (grille dédiée) :** Tentes-garages : à l'abri dès ce week-end — Cadre acier et bâche traitée anti-UV, de 3 × 3 m à 4 × 7,6 m, expédiées en 5 à 12 jours ouvrés. Montage à deux sans outil spécial, piquets et haubans fournis, aucune fondation à prévoir.
...
**Titre de section :** Faut-il déclarer votre carport ?

Comptez sur trois seuils, à confirmer auprès de votre mairie :
- **Emprise au sol ≤ 5 m²** : en général aucune formalité.
- **Entre 5 et 20 m²** : déclaration préalable de travaux en mairie.
- **Plus de 20 m²** : permis de construire.
- **Distances aux limites séparatives** : selon le PLU de votre commune, souvent 3 mètres ou en limite.
- **Taxe d'aménagement** : possible pour une surface close et couverte ; un carport ouvert en est souvent exempté, la mairie tranche.

Chaque fiche Sous Abri indique l'emprise au sol du modèle et la démarche qui s'applique. Notre guide offert vous accompagne pas à pas, formulaire compris ; le service urbanisme de votre mairie et service-public.fr restent la référence pour confirmer votre cas.

**Texte retenu pour le thème :** Comptez sur trois seuils, à confirmer auprès de votre mairie : emprise ≤ 5 m², en général aucune formalité ; entre 5 et 20 m², déclaration préalable de travaux ; plus de 20 m², permis de construire. Chaque fiche Sous Abri indique l'emprise au sol du modèle et la démarche qui s'applique, et notre guide offert vous accompagne pas à pas, formulaire compris.

**Lien :** Lire le guide déclaration et permis → *(page « Faut-il déclarer votre carport ? », `guide-declaration-carport`)*

---

## 6. Comparaison — angle service et sélection
...
**4 items (mêmes mots partout, charte §Piliers) :**
...
Comptez sur l'emprise au sol : en général aucune formalité en dessous de 5 m², une déclaration préalable entre 5 et 20 m², un permis de construire au-delà, à confirmer auprès de votre mairie. Chaque fiche indique la démarche qui s'applique au modèle, et notre guide déclaration offert vous accompagne pas à pas.

**Le carport va-t-il tenir au vent ?**
Oui, à condition de l'ancrer. Prévoyez une fixation au sol dans tous les cas : plots béton hors gel ou dalle pour un carport, piquets et haubans fournis pour une tente-garage. Chaque fiche détaille le kit d'ancrage livré, et notre guide montage et ancrage vous indique quoi prévoir selon votre sol, terre, dalle ou enrobé.
...
**Titre :** Choisissez votre abri, tout est prévu jusqu'au montage

**CTA :** Voir les carports

---

## Images — ALT et rôle de vente (5–6 visuels composés à partir de l'image produit du fournisseur, jamais la photo AliExpress brute)

1. Carport aluminium toit plat monté devant un pavillon, voiture grise dessous, temps couvert — ALT « Carport aluminium 2 voitures toit plat installé devant une maison » — rôle : désir / projection (l'abri chez soi)
2. Gros plan sur un point d'ancrage au sol (plot béton, platine) — ALT « Ancrage au sol d'un carport, plot béton » — rôle : réassurance technique (le guide montage et ancrage en pratique)
3. Montage à deux personnes, pièces numérotées visibles — ALT « Montage à deux d'un carport en kit, pièces numérotées » — rôle : montage à deux, sans outil spécial
4. Camion de livraison et colis en bordure de trottoir — ALT « Livraison d'un carport en kit, colis en bordure de trottoir » — rôle : livraison offerte sur rendez-vous, mise en scène
5. Schéma coté avec dimensions et hauteur de passage — ALT « Schéma coté d'un carport aluminium avec dimensions » — rôle : aide à la décision (cotes, hauteur de passage)
6. Tente-garage montée avec portes ouvertes, voiture à l'intérieur, jour de pluie — ALT « Tente-garage fermée protégeant une voiture sous la pluie » — rôle : désir (au sec par tous les temps)
