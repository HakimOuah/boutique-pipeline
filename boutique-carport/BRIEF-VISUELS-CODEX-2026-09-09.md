...
- **Fond studio** (slots `face`, `carte`) : sable clair uni `#F4F1EA` (fond du site), lumière douce latérale haute-gauche, une seule ombre portée diffuse. Pas de dégradé pierre/craie.
...
- **Voitures** : berlines et SUV courants en France (compacte, break, SUV compact, une citadine électrique), couleurs sobres (gris, blanc, bleu nuit), plaques floutées ou absentes, jamais de logo constructeur lisible. Camping-car profilé blanc pour les slots camping-car ; utilitaire ou fourgon pour la tente 3 × 6.
