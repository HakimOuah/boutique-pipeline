#!/usr/bin/env python3
"""Mesure DataForSEO France (wrapper tolerant aux volumes null).
...
def main():
    ...
    out, cout = {}, 0.0
    for g in a.graines:
        lignes, total, c = K.suggestions(g, pages=a.pages, location="France",
                                         language="French", cache=not a.refresh)
        cout += c
